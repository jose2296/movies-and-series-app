        ...
        <div className='drawer'>
            ...
            <div className='drawer-content'>
                <div className='py-4 flex flex-col justify-stretch gap-4 md:gap-10 h-[100vh]'>
                    <header className='px-4 flex w-full gap-5 items-center border-b-2 pb-2 border-slate-500'>
                        ...
                        {activeTab === 'search' &&
                            <label className='group w-full max-w-96 h-[40px] min-h-[40px] input border-2 border-base-content border-opacity-40 flex items-center gap-2 focus-within:outline-none focus:outline-none focus:border-base-content focus-within:border-base-content'>
            ...
            <div className='drawer-side'>
                ...
                <ul className='menu p-4 max-w-[70%] w-96 min-h-full bg-base-200 text-xl items-start gap-2'>
                    {(['movies', 'series', 'popular', 'search'] as Tab[]).map(tab => (
